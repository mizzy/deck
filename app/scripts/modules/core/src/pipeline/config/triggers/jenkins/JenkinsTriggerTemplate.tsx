...
export interface IJenkinsTriggerTemplateState {
  builds?: IBuild[];
...
export class JenkinsTriggerTemplate extends React.Component<
  ITriggerTemplateComponentProps,
  IJenkinsTriggerTemplateState
> {
  ...
  private buildLoadSuccess = (allBuilds: IBuild[]) => {
    const newState: Partial<IJenkinsTriggerTemplateState> = {
      buildsLoading: false,
    };
